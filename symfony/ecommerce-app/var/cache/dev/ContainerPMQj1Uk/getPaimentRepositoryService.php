 ...
 */
class getPaimentRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PaimentRepository' shared autowired service.
     *
     * @return \App\Repository\PaimentRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PaimentRepository.php';

        return $container->privates['App\\Repository\\PaimentRepository'] = new \App\Repository\PaimentRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
