 ...
 */
class getLigneCommandRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LigneCommandRepository' shared autowired service.
     *
     * @return \App\Repository\LigneCommandRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LigneCommandRepository.php';

        return $container->privates['App\\Repository\\LigneCommandRepository'] = new \App\Repository\LigneCommandRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
